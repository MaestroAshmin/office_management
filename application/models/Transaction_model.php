...
class Transaction_model extends CI_model{
    ...
    public function add_transaction($data){
        ...
        try{
            ...
            $this->db->insert('tbl_data',$insertData);
    ...
    public function get_transactions(){
        $query = $this->db->select('*')->from('tbl_data')->order_by('created_at', 'DESC')->get();
        if ($query) {
    ...
    public function get_transaction($id){
        $query = $this->db->select('*')->from('tbl_data')->where('ID',$id)->get(); 
        if ($query) {
    ...
    public function update_transaction($update_data){
        try{
            ...
            $query = $this->db->update('tbl_data',$data);
