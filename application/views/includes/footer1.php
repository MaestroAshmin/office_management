      ...
      <!-- End of Main Content -->
<!-- Footer -->
      <footer class="sticky-footer bg-white footer" data-siteurl="<?php echo site_url();?>">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Bonjour Management Pvt. Ltd <?php echo date('Y');?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script type="text/javascript" src="<?php echo site_url();?>js/jquery-validate_additional-methods.min.js"></script>
 ...
 <!-- Page level plugins -->
  ...
  <script src="<?php echo site_url();?>js/nepali.datepicker.v3.min.js" type="text/javascript"></script>
