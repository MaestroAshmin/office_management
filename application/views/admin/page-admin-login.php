...
<head>
  ...
  <title><?php echo $title;?> - Unified Communication Pvt. Ltd</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6">
                <img src="<?php echo site_url();?>img/logo_12.png" class="mx-auto d-block pt-5">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                ...
                <?php } ?>
                  ...
                  <form class="user" method="post" action="<?php echo site_url();?>admin/login">
                    ...
                    <input type="submit" class="btn btn-primary btn-user btn-block" value="Login" name="admin_login">
                  </form>
                  <div class="text-center">
